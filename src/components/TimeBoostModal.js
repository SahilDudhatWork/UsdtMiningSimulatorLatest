...
const TimeBoostModal = ({
  ...
  const handleWatchAd = async onWatchAdCallback => {
    ...
    try {
      ...
      showToast.error('Ad Error', 'Unable to load ad. Please try again later.');
    }
  };
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.optionsContainer}>
              ...
              >
                <View style={styles.optionLeft}>
                  ...
                  <View>
                    <Text
                      style={[
                        styles.optionTitle,
                        isAdDisabled && styles.disabledText,
                      ]}
                    >
                      +30 Minutes
                    </Text>
                ...
                <View style={styles.optionRight}>
                  <Text
                    style={[
                      styles.freeText,
                      isAdDisabled && styles.disabledFreeText,
                    ]}
                  >
              ...
              <TouchableOpacity
                style={[
                  styles.optionCard,
                  userBalance < 250 && styles.disabledCard,
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.optionCard,
                  userBalance < 400 && styles.disabledCard,
                ]}
